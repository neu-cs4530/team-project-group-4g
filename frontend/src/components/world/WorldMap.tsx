  ...
  update() {
    ...
    if (this.player && this.cursors) {
      ...
      if ((myPlayer?.visible === true) || myVehicle) {
        ...
        // Fix incorrect locations and directions of other players in this town
        if (
          !this.lastLocation ||
          this.lastLocation.x !== (body.right + body.left) / 2 || // this.lastLocation.x !== body.x ||
          this.lastLocation.y !== (body.top + body.bottom) / 2 || // this.lastLocation.y !== body.y ||
          ...
          this.lastLocation.x = (body.right + body.left) / 2; // this.lastLocation.x = body.x;
          this.lastLocation.y = (body.top + body.bottom) / 2; // this.lastLocation.y = body.y;
          this.lastLocation.rotation = primaryDirection || this.lastLocation.rotation || 'front'; // this.lastLocation.rotation = primaryDirection || 'front';
          this.lastLocation.moving = isMoving;
